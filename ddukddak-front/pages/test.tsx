  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen xl:place-content-center">
      <div className="bg-white dark:bg-black flex flex-col justify-between sm:bg-red-400 md:bg-teal-500 lg:bg-blue-500 xl:bg-yellow-500 p-6 rounded-3xl shadow-xl">
        ...
        <div
          className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-100 hover:text-black
      ...
      <div className="flex flex-col space-y-2 p-5">
        ...
        <input
          type="file"
          className="file:border-0 file:rounded-md file:bg-purple-500 transition-colors file:cursor-pointer file:hover:text-pink-500 file:hover:bg-white file:hover:border-pink-500 file:hover:border"
        />
